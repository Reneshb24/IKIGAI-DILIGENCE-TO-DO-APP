...
class TaskManagerApp:
    ...
    def initialize_drive_api(self):
        ...
        # Replace "credentials.json" with the path to your own Google Service Account JSON file
        # You can generate this file from Google Cloud Console (see README for setup steps)
    ...
    def send_email_with_attachment(self, to_email, subject, message, attachment_path):
	    try:
	        msg = MIMEMultipart()
	        msg['From'] = "examle@gmail.com" #Add your gmail account 
	        msg['To'] = to_email
	        msg['Subject'] = subject
	        ...
	        with smtplib.SMTP('smtp.gmail.com', 587) as server:
	            server.starttls()
	            server.login("example@gmail.com", "**** **** ****" ) #Replace with your Gmail + App Password
...
command=self.create_main_page,width=150,).place(relx=0.5, rely=0.85, anchor="center")
    ...
    def send_email(self, to_email, subject, message):
	        try:
	            ...
	            sender_password = "**** **** **** ****" #Replace with Gmail 16 digit App Password
	            msg = MIMEMultipart()
